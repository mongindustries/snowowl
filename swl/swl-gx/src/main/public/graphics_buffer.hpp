...
struct graphics_buffer<graphics_buffer_type::typeData> {
  ...
  graphics_buffer   (const cx::exp::ptr_ref<graphics_context>& context, location locality, size_t size) { }

  graphics_buffer   (const cx::exp::ptr_ref<graphics_context>& context, location locality, const std::vector<char>& buffer) { }
